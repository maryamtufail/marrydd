...
const defaultProjects: Project[] = [
  { id: "1", title: "Learingo", image: "./learingo.png", alt: "Learingo project thumbnail" },
  { id: "2", title: "RiverCity", image: "./rivercity.png", alt: "RiverCity project preview image" },
  { id: "3", title: "Wago Bank", image: "./wago.png", alt: "Wago Bank app interface preview" },
  { id: "4", title: "Light Star", image: "./lightstar.png", alt: "Light Star branding preview" },
  { id: "5", title: "DVK", image: "./dvk.png", alt: "DVK dashboard screenshot" },
  { id: "6", title: "IKS", image: "./iks.png", alt: "IKS platform UI preview" },
  { id: "7", title: "Reploy Me", image: "./reployme.png", alt: "Reploy Me project cover image" },
  { id: "8", title: "Vax Assist", image: "./vaxassist.png", alt: "Vax Assist mobile app preview" },
]

              ...
              <div className="flex flex-col gap-10 lg:flex-row lg:gap-20">
                <article className="flex-1">
                  ...
                  <header className="prose dark:prose-invert text-sm leading-relaxed max-w-3xl">
                    ...
                    <p className="mb-6">
                      Rivercity Technology Services LTD is a relationship-first
                      Managed IT Services provider specializing in
                      cybersecurity, business process optimization, and
                      technology support. As part of their digital
                      transformation, I redesigned their public website and
                      created a complete internal{" "}
                      <strong>MSP Operations Dashboard</strong> to help their
                      team manage clients, tickets, performance metrics,
                      devices, and security alerts with unmatched clarity.
                    </p>
                    ...
                    <img
                      src="/dashboard.png"
                      className="mb-6 w-full h-auto max-w-xl object-cover"
                      alt="overview"
                    />
                    <img
                      src="/finances.png"
                  ...
                  <div className="prose dark:prose-invert text-sm leading-relaxed max-w-3xl mb-8">
                    ...
                    <p className="mb-4">
                      The previous website lacked structure, clarity, and failed
                      to communicate Rivercity’s relationship-driven identity. I
                      rebuilt the experience with:
                    </p>
                    <ul className="list-disc pl-5 text-xs space-y-1 mb-4">
                      <li>
                        Clear brand messaging focused on trust, transparency,
                        and partnership
                      </li>
                      <li>
                        SEO-optimized structure to increase organic visibility
                        in Saskatoon
                      </li>
                      <li>
                        Dedicated service pages for IT, cybersecurity, backups,
                        VoIP, and hosting
                      </li>
                      <li>
                        Consistent component library and scalable layout system
                      </li>
                      <li>
                        Accessibility improvements (contrast, semantic layout,
                        keyboard navigation)
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="prose dark:prose-invert text-sm leading-relaxed max-w-3xl mb-8">
                    <h2 className="text-lg font-semibold mb-3">
                      MSP Internal Operations Dashboard
                    </h2>
                    <p className="mb-4">
                      Rivercity’s team manages dozens of businesses, hundreds of
                      devices, and thousands of support tickets. The previous
                      tools were scattered between multiple systems, causing
                    ...
                    <ul className="list-disc pl-5 text-xs space-y-1 mb-4">
                      <li>
                        Unified ticket management with priority visualization
                      </li>
                      <li>
                        Device & endpoint health monitoring via clean status
                        badges
                      </li>
                      <li>Client-by-client overview with at-a-glance KPIs</li>
                      <li>
                        Technician performance dashboard with time tracking
                      </li>
                    ...
                    <ul className="list-disc pl-5 text-xs space-y-1 mb-4">
                      ...
                      <li>
                        Workflow mapping: tickets, escalations, device audits
                      </li>
                      <li>Identification of bottlenecks in response times</li>
                      <li>
                        Audit of existing ITSM tools (Syncro, NinjaOne,
                        Autotask)
                      </li>
                    </ul>
                    ...
                    <ul className="list-disc pl-5 text-xs space-y-1 mb-4">
                      <li>
                        Full custom dashboard UI/UX using component-driven
                        design
                      </li>
                      <li>
                        Modular layout for future expansion (alerts, billing,
                        automation)
                      </li>
                    ...
                    <div className="rounded-lg border bg-white p-4 shadow-sm">
                      ...
                      <dl className="space-y-2 text-xs">
                        ...
                        <div>
                          ...
                          <dd>
                            Next.js • React • Tailwind • UI/UX Design System
                          </dd>
                        </div>
                        <div>
                          <dt className="font-medium text-muted-foreground">
      ...
      <div className="lg:hidden">
        ...
        <section className="px-4 py-10">
          ...
          <div className="prose dark:prose-invert text-sm leading-relaxed">
            ...
            <p className="mb-4">
              Redesigned Rivercity’s website and created their internal MSP
              dashboard for ticketing, monitoring, and technician operations.
            </p>

            <h2 className="text-lg font-semibold mb-3">Website Redesign</h2>
            <p className="mb-4">
              Clear messaging, improved SEO, and a component-driven layout for
              scalable growth.
            </p>

            <h2 className="text-lg font-semibold mb-3">Internal Dashboard</h2>
            <p className="mb-4">
              Unified ticketing, client KPIs, and device monitoring in one
              platform.
            </p>

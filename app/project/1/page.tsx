              ...
              <div className="flex flex-col gap-10 lg:flex-row lg:gap-20">
                <article className="flex-1">
                  ...
                  <header className="prose dark:prose-invert text-sm leading-relaxed max-w-3xl">
                    ...
                    <h2 className="text-3xl font-semibold mb-4 text-blue-500">AI-Enhanced Learning Management System</h2>
                    <p className="mb-6">
                      Learingo is a cutting-edge <strong>LMS (Learning Management System)</strong> designed for educational institutions, online academies, and corporate training programs. Leveraging <strong>AI-assisted learning</strong>, Learingo delivers adaptive courses, intelligent assessments, real-time analytics, and engaging student experiences in one scalable platform.
                    </p>

                    <ul className="flex flex-wrap gap-3 text-xs mb-6">
                      {["LMS", "EdTech", "AI-assisted learning", "Next.js", "Tailwind", "Mobile App"].map((t) => (
                        <li
                          key={t}
                  ...
                  <div className="prose dark:prose-invert text-sm leading-relaxed max-w-3xl mb-8">
                    ...
                    <p className="mb-4">
                      Learingo also includes a fully responsive mobile app for students on the go, featuring:
                    </p>
                    <ul className="list-disc pl-5 text-xs space-y-1 mb-4">
                      ...
                      <li>Mobile quizzes with AI-assisted adaptive assessments</li>
                  ...
                  <div className="prose dark:prose-invert text-sm leading-relaxed max-w-3xl mb-6">
                    <h2 className="text-lg font-semibold mb-3">Challenges in Enterprise Learning</h2>
                    <p className="mb-4">
                      Traditional LMS platforms are often slow, outdated, and difficult for instructors to manage at scale. Learingo addresses key challenges such as low engagement, complicated content management, limited scalability, and lack of transparency in adaptive assessments.
                    </p>

                    <h3 className="text-base font-medium mb-2">Research & Discovery</h3>
                    <ul className="list-disc pl-5 text-xs space-y-1 mb-4">
                      <li>Interviews: 25 instructors and 40 students across 8 institutions</li>
                      <li>Pain point mapping: assignment flows, grading, discovery</li>
                      <li>AI evaluation: adaptive difficulty and question generation models</li>
                    </ul>

                    <h3 className="text-base font-medium mb-2">Design & Development</h3>
                    <ul className="list-disc pl-5 text-xs space-y-1 mb-4">
                      <li>Component-driven, atomic-first design system</li>
                      <li>Next.js for SSR/ISR and Tailwind CSS for utility-first styling</li>
                      <li>AI-assisted question generator and adaptive assessments</li>
                      <li>Progressive loading for fast interactive pages</li>
                    </ul>

                    <h3 className="text-base font-medium mb-2">Results & Impact</h3>
                    <p className="mb-3">
                      Learingo’s launch delivered measurable improvements in engagement, retention, and instructor efficiency.
                    </p>
                    ...
                    <div className="rounded-lg border bg-white p-4 shadow-sm">
                      ...
                      <dl className="space-y-2 text-xs">
                        ...
                        <div>
                          ...
                          <dd>Next.js • React • Node.js • React Native • Tailwind • OpenAPI • TypeScript  </dd>
                        </div>
                        <div>
                          <dt className="font-medium text-muted-foreground">Focus</dt>
                          <dd>Adaptive assessments • Dashboards • Live sessions • Mobile App</dd>
                        </div>
                        <div>
                          <dt className="font-medium text-muted-foreground">Live Link</dt>
                          <dd>
                            <a href="https://learnigo.org" target="_blank" className="text-blue-600 underline">
                              learnigo.org
                            </a>
                          </dd>
                        </div>
      ...
      <div className="lg:hidden">
        ...
        <section className="px-4 py-10">
          ...
          <div className="prose dark:prose-invert text-sm leading-relaxed">
            <h1 className="text-xl font-semibold mb-4">Learingo — AI-Enhanced LMS</h1>
            <p className="mb-4">
              AI-assisted LMS with adaptive quizzes, dashboards, live sessions, and mobile-first experience for learners anywhere.
            </p>

            <h2 className="text-lg font-semibold mb-3">Mobile App</h2>
            <p className="mb-4">
              Complete mobile learning experience with push notifications, offline mode, and adaptive quizzes.
            </p>
            ...
            <p className="mb-4">Engagement increased by 300%, and instructor workflows became 40% faster.</p>
